...
create_ring(RingSize, NumNodes) ->
    ...
    application:set_env(riak_core, wants_claim_fun, {riak_core_membership_claim, default_wants_claim}),
    application:set_env(riak_core, choose_claim_fun, {riak_core_membership_claim, default_choose_claim}),
